...
if(identical(as.character(nrow(resolved_stat)),"0")){
addTable(rtffile, "Tidak ada data")
} else {addTable(rtffile, resolved_stat)}
addNewLine(rtffile)
...
addNewLine(rtffile)
},error=function(e){cat("No unresolved permit left:",conditionMessage(e), "\n")})
