...
##[QUES]=group
Wdir<-"C:/Dataset QUES-H/04_SWAT scenarios/Merangin__LC2005/TxtInOut/"
location<-"batang merangin"
init.date="01/01/2003"
final.date="31/12/2005"
swatrun=0
end.rch=10
obsv="C:/Dataset QUES-H/04_SWAT scenarios/Merangin__LC2005/TxtInOut/OBSmerprn2.txt"
##passfilenames
##showplots
